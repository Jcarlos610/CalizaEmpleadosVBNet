...
Public Class CL_Employee
    ...
    Public Function Get_AllAdministrativeEmployees() As DataTable

        Try
            DB_Command = New SqlCommand With {
                .CommandText = "SEL_ALLADMINISTRATIVEEMPLOYEES",
                .CommandType = CommandType.StoredProcedure
            }
            DB_Connection.Open()
            DB_Command.Connection = DB_Connection
        ...
        Catch ex As Exception
            DB_Connection.Close()
            MsgBox("Ocurrio el siguiente error: " & ex.Message & " CL_Employees.Get_AllAdministrativeEmployees()")
