...
Partial Class MD_INS_Benefits
    ...
    '    ' DT_ValidTo
    '    ' 
    '    DT_ValidTo.Location = New Point(568, 142)
    ...
    '    LB_ValidTo.Location = New Point(568, 124)
    ...
    '    ' DT_ValidFrom
    '    ' 
    '    DT_ValidFrom.Location = New Point(319, 142)
    ...
    '    LB_ValidFrom.Location = New Point(319, 124)
    ...
    '    CB_NumberOfDays.Location = New Point(159, 142)
    '    CB_NumberOfDays.Name = "CB_NumberOfDays"
    '    CB_NumberOfDays.Size = New Size(130, 23)
    '    CB_NumberOfDays.TabIndex = 5
    '    ' 
    '    ' LB_AplicationDay
    '    ' 
    '    LB_AplicationDay.AutoSize = True
    '    LB_AplicationDay.Location = New Point(159, 124)
    '    LB_AplicationDay.Name = "LB_AplicationDay"
    '    LB_AplicationDay.Size = New Size(97, 15)
    ...
    '    CB_Period.Location = New Point(17, 142)
    '    CB_Period.Name = "CB_Period"
    '    CB_Period.Size = New Size(121, 23)
    '    CB_Period.TabIndex = 4
    '    ' 
    '    ' LB_Period
    '    ' 
    '    LB_Period.AutoSize = True
    '    LB_Period.Location = New Point(16, 124)
    '    LB_Period.Name = "LB_Period"
    '    LB_Period.Size = New Size(121, 15)
    ...
    Private Sub InitializeComponent()
        ...
        LB_Title.Size = New Size(217, 30)
        LB_Title.TabIndex = 105
        LB_Title.Text = "Registro de beneficios"
        ' 
        ' MD_INS_Benefits
        ' 
        AutoScaleDimensions = New SizeF(7F, 15F)
