...
Public Class CL_Benefits
    ...
    Private _BENEF_PERCENT As Object
    ...
    Public Property BENEF_PERCENT As Object
        Get
            Return _BENEF_PERCENT
        End Get
        Set(value As Object)
            _BENEF_PERCENT = value
        End Set
    End Property
    ...
    Sub New(BENEF_NAME, BENEF_DESCR, BENEF_TYPE, BENEF_DATEC, BENEF_CREBY, BENEF_AUTH, BENEF_AMMOU, BENEF_STAT, BENEF_VALFR, BENEF_VALTO, BENEF_PERCENT)
        ...
        _BENEF_PERCENT = BENEF_PERCENT
    End Sub


    Sub New(BENEF_ID, BENEF_NAME, BENEF_DESCR, BENEF_TYPE, BENEF_DATEC, BENEF_CREBY, BENEF_AUTH, BENEF_AMMOU, BENEF_STAT, BENEF_VALFR, BENEF_VALTO, BENEF_PERCENT)
        DB_Connection = New SqlConnection(My.Settings.ConnectionString)
    ...
    Public Function InsertBenefit()
        ...
        Try
            ...
            'DB_Command.Parameters.AddWithValue("BENEF_PERCENT", _BENEF_PERCENT)
            DB_Command.Parameters.AddWithValue("BENEF_PERCENT", If(_BENEF_PERCENT = "", DBNull.Value, _BENEF_PERCENT))
            DB_Command.Parameters.AddWithValue("BENEF_AMMOU", If(_BENEF_AMMOU = "", DBNull.Value, _BENEF_AMMOU))
    ...
    Public Function Get_AllActiveManualAutomaticBenefits() As DataTable
        Try
            DB_Command = New SqlCommand With {
                .CommandText = "SEL_GETALLMANUALAUTOMATICACTIVEBENEFITS",
                .CommandType = CommandType.StoredProcedure
            }
            DB_Connection.Open()
            DB_Command.Connection = DB_Connection
        ...
        Catch ex As Exception
            DB_Connection.Close()
            MsgBox("Ocurrio el siguiente error: " & ex.Message & " CL_Benefits.Get_AllActiveManualAutomaticBenefits()")
