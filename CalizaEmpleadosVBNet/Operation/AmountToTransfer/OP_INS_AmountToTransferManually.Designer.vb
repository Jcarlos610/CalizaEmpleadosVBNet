...
Partial Class OP_INS_AmountToTransferManually
    ...
    Private Sub InitializeComponent()
        ...
        LB_TotalEmployees.TabIndex = 116
        ...
        DGV_Amtrans.Location = New Point(12, 262)
        DGV_Amtrans.Name = "DGV_Amtrans"
        DGV_Amtrans.ReadOnly = True
        DGV_Amtrans.Size = New Size(1218, 401)
        DGV_Amtrans.TabIndex = 115
        ' 
        ' GroupBox1
        ' 
        ...
        LB_Title.Size = New Size(247, 30)
        LB_Title.TabIndex = 113
        LB_Title.Text = "Carga de montos manual"
        ' 
        ' OP_INS_AmountToTransferManually
        ' 
        ...
        Name = "OP_INS_AmountToTransferManually"
        Text = "Registro manual de montos a transferir"
