...
Public Class CL_EmployeeLoans
    ...
    Public Function Get_AmmountOfLoandByEmployee() As DataTable
        Dim dt As New DataTable

        Try
            DB_Connection.Open()

            DB_Command = New SqlCommand("SEL_GETLOANSAMMOUNTBYEMPLOYEE", DB_Connection)
            DB_Command.CommandType = CommandType.StoredProcedure
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error al obtener el monto de descuentos", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            DB_Connection.Close()
        End Try
