...
Partial Class OP_BenefitBotonero
    ...
    Private Sub InitializeComponent()
        ...
        GB_DebtInformation.TabIndex = 113
        GB_DebtInformation.TabStop = False
        GB_DebtInformation.Text = "Empleados con Bono de Botonero pendiente de activar"
        ' 
        ' LB_SelectEmployee
        ' 
        ...
        ' BT_Save
        ' 
        BT_Save.Location = New Point(1124, 212)
        BT_Save.Name = "BT_Save"
        BT_Save.Size = New Size(75, 23)
        BT_Save.TabIndex = 10
        BT_Save.Text = "Asignar"
        ...
        Name = "OP_BenefitBotonero"
        Text = "Asignar bono de botonero"
